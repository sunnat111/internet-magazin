...
function App() {
  ...
  return (
    <>
      <Routes>
        <Route path="/" element={<Menu cart={cart} />} />
        <Route path="/cart" element={<Cart cart={cart} removeProduct={removeProduct} />} />
        <Route path="/:id" element={<ProductItem addCart={addCart} cart={cart} alerts={alerts}/>} />
        <Route path="/login" element={<Login />} />
        <Route path="/profile" element={<Profile />} />
        <Route path="/register" element={<Register />} />
        <Route path="/readyorder" element={<ReadyOrder cart={cart} remove={remove}/>} />
      </Routes>
    </>
  );
}
